...
3. In the new ETMS tab, paste that URL into the address bar and press Enter or tap on the suggested link. The browser will render the raw HTML source of the page instead of the styled page.
